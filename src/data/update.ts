...
export const filterUpdateEntities = (
  ...
  (
    ...
    if (a.attributes.title === "KS Assistant Core") {
      return -3;
    }
    if (b.attributes.title === "KS Assistant Core") {
      return 3;
    }
    if (a.attributes.title === "KS Assistant Operating System") {
      return -2;
    }
    if (b.attributes.title === "KS Assistant Operating System") {
      return 2;
    }
    if (a.attributes.title === "KS Assistant Supervisor") {
      return -1;
    }
    if (b.attributes.title === "KS Assistant Supervisor") {
      return 1;
    }
